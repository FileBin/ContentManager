...
namespace ContentManager.Api.Persistence.Migrations
{
    ...
    [Migration("20240922192809_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContentManager.Api.Contracts.Domain.Data.Models.Auth.User", b =>
                {
            ...
            modelBuilder.Entity("ContentManager.Api.Contracts.Domain.Data.Models.Auth.UserGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("EditorGroupId")
                        .HasColumnType("uuid")
                        .HasColumnName("editor_group_id");
                    ...
                    b.Property<Guid?>("ReaderGroupId")
                        .HasColumnType("uuid")
                        .HasColumnName("reader_group_id");

                    b.HasKey("Id")
                        .HasName("pk_user_groups");

                    b.HasIndex("EditorGroupId")
                        .HasDatabaseName("ix_user_groups_editor_group_id");

                    b.HasIndex("OwnerGroupId")
                        .HasDatabaseName("ix_user_groups_owner_group_id");

                    b.HasIndex("OwnerUserId")
                        .HasDatabaseName("ix_user_groups_owner_user_id");

                    b.HasIndex("ReaderGroupId")
                        .HasDatabaseName("ix_user_groups_reader_group_id");
            ...
            modelBuilder.Entity("ContentManager.Api.Contracts.Domain.Data.Models.ContentCollection", b =>
                {
                    ...
                    b.HasIndex("EditorGroupId")
                        .HasDatabaseName("ix_content_collections_editor_group_id");

                    b.HasIndex("OwnerGroupId")
                        .HasDatabaseName("ix_content_collections_owner_group_id");

                    b.HasIndex("OwnerUserId")
                        .HasDatabaseName("ix_content_collections_owner_user_id");

                    b.HasIndex("ReaderGroupId")
                        .HasDatabaseName("ix_content_collections_reader_group_id");
            ...
            modelBuilder.Entity("ContentManager.Api.Contracts.Domain.Data.Models.ContentPost", b =>
                {
                    ...
                    b.HasIndex("EditorGroupId")
                        .HasDatabaseName("ix_content_posts_editor_group_id");

                    b.HasIndex("OwnerGroupId")
                        .HasDatabaseName("ix_content_posts_owner_group_id");

                    b.HasIndex("OwnerUserId")
                        .HasDatabaseName("ix_content_posts_owner_user_id");

                    b.HasIndex("ReaderGroupId")
                        .HasDatabaseName("ix_content_posts_reader_group_id");
            ...
            modelBuilder.Entity("ContentManager.Api.Contracts.Domain.Data.Models.Auth.User", b =>
                {
                    b.HasOne("ContentManager.Api.Contracts.Domain.Data.Models.Auth.UserGroup", "Group")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("ContentManager.Api.Contracts.Domain.Data.Models.Auth.UserGroup", b =>
                {
                    b.HasOne("ContentManager.Api.Contracts.Domain.Data.Models.Auth.UserGroup", "EditorGroup")
                        .WithMany()
                        .HasForeignKey("EditorGroupId")
                        .HasConstraintName("fk_user_groups_user_groups_editor_group_id");

                    b.HasOne("ContentManager.Api.Contracts.Domain.Data.Models.Auth.UserGroup", "OwnerGroup")
                        .WithMany()
                        .HasForeignKey("OwnerGroupId")
                        .HasConstraintName("fk_user_groups_user_groups_owner_group_id");

                    b.HasOne("ContentManager.Api.Contracts.Domain.Data.Models.Auth.User", "Owner")
                        .WithMany()
                        .HasForeignKey("OwnerUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_groups_users_owner_user_id");

                    b.HasOne("ContentManager.Api.Contracts.Domain.Data.Models.Auth.UserGroup", "ReaderGroup")
                        .WithMany()
                        .HasForeignKey("ReaderGroupId")
                        .HasConstraintName("fk_user_groups_user_groups_reader_group_id");

                    b.Navigation("EditorGroup");
            ...
            modelBuilder.Entity("ContentManager.Api.Contracts.Domain.Data.Models.ContentCollection", b =>
                {
                    b.HasOne("ContentManager.Api.Contracts.Domain.Data.Models.Auth.UserGroup", "EditorGroup")
                        .WithMany()
                        .HasForeignKey("EditorGroupId")
                        .HasConstraintName("fk_content_collections_user_groups_editor_group_id");

                    b.HasOne("ContentManager.Api.Contracts.Domain.Data.Models.Auth.UserGroup", "OwnerGroup")
                        .WithMany()
                        .HasForeignKey("OwnerGroupId")
                        .HasConstraintName("fk_content_collections_user_groups_owner_group_id");
                    ...
                    b.HasOne("ContentManager.Api.Contracts.Domain.Data.Models.Auth.User", "Owner")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_content_collections_users_owner_user_id");

                    b.HasOne("ContentManager.Api.Contracts.Domain.Data.Models.Auth.UserGroup", "ReaderGroup")
                        .WithMany()
                        .HasForeignKey("ReaderGroupId")
                        .HasConstraintName("fk_content_collections_user_groups_reader_group_id");
            ...
            modelBuilder.Entity("ContentManager.Api.Contracts.Domain.Data.Models.ContentPost", b =>
                {
                    b.HasOne("ContentManager.Api.Contracts.Domain.Data.Models.Auth.UserGroup", "EditorGroup")
                        .WithMany()
                        .HasForeignKey("EditorGroupId")
                        .HasConstraintName("fk_content_posts_user_groups_editor_group_id");

                    b.HasOne("ContentManager.Api.Contracts.Domain.Data.Models.Auth.UserGroup", "OwnerGroup")
                        .WithMany()
                        .HasForeignKey("OwnerGroupId")
                        .HasConstraintName("fk_content_posts_user_groups_owner_group_id");
                    ...
                    b.HasOne("ContentManager.Api.Contracts.Domain.Data.Models.Auth.User", "Owner")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_content_posts_users_owner_user_id");

                    b.HasOne("ContentManager.Api.Contracts.Domain.Data.Models.Auth.UserGroup", "ReaderGroup")
                        .WithMany()
                        .HasForeignKey("ReaderGroupId")
                        .HasConstraintName("fk_content_posts_user_groups_reader_group_id");
