...
namespace ContentManager.Api.Persistence.Migrations
{
    ...
    [Migration("20241005205918_AddedPreviewAndTimestamps")]
    partial class AddedPreviewAndTimestamps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContentManager.Api.Contracts.Domain.Data.Models.ContentPost", b =>
                {
                    ...
                    b.HasIndex("PreviewId")
                        .HasDatabaseName("ix_content_posts_preview_id");
            ...
            modelBuilder.Entity("ContentManager.Api.Contracts.Domain.Data.Models.ContentPost", b =>
                {
                    b.HasOne("ContentManager.Api.Contracts.Domain.Data.Models.Content", "Preview")
                        .WithMany()
                        .HasForeignKey("PreviewId")
                        .HasConstraintName("fk_content_posts_contents_preview_id");
